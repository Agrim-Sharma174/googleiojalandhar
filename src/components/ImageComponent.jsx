...
const ImageComponent = () => {
  ...
  return (
    <div>
      {screenSize === 'mobile' && <img src={banner_mobile} width="100%" height="270px" alt="Mobile Image" />}
      {screenSize === 'medium' && <img src={banner_mid} width="100%" height="300px" alt="Medium Image" />}
      {screenSize === 'large' && <img src={banner_large} width="100%" height="300px" alt="Large Image" />}
    </div>
  );
};
